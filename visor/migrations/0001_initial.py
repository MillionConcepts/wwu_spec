# Generated by Django 4.0.4 on 2022-06-13 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wavelengths', models.TextField(db_index=True, null=True)),
                ('filters', models.TextField(db_index=True, null=True)),
                ('filter_wavelengths', models.TextField(db_index=True)),
                ('url', models.TextField(blank=True, db_index=True)),
                ('description', models.TextField(blank=True, db_index=True)),
                ('display_order', models.IntegerField(blank=True, db_index=True, default=10000)),
                ('resample_only', models.BooleanField(db_index=True, default=False)),
            ],
        ),
        migrations.CreateModel(
            name='Library',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, db_index=True, max_length=100, null=True, verbose_name='Path to Image')),
                ('import_notes', models.TextField(blank=True, db_index=True, null=True, verbose_name='File import notes')),
                ('locality', models.TextField(blank=True, db_index=True, verbose_name='Locality')),
                ('min_wavelength', models.FloatField(blank=True, db_index=True, verbose_name='Minimum Wavelength')),
                ('sample_name', models.CharField(blank=True, db_index=True, max_length=40, verbose_name='Sample Name')),
                ('max_wavelength', models.FloatField(blank=True, db_index=True, verbose_name='Maximum Wavelength')),
                ...
                ('sample_id', models.CharField(db_index=True, max_length=40, unique=True, verbose_name='Sample ID')),
                ('original_sample_id', models.CharField(db_index=True, max_length=40, verbose_name='Original Sample ID')),
